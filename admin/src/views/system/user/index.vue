...
<script>
import { listUser, getUser, delUser, addUser, updateUser, exportUser, updateUserPwdByAdmin, changeUserStatus, importTemplate } from '@/api/system/user'
  ...
  methods: {
    ...
    handleResetPwd (row) {
      this.$prompt('请输入"' + row.userName + '"的新密码', '提示', {
        ...
        updateUserPwdByAdmin(row.id, query).then(res => {
