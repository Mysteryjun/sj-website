    ...
    <el-table v-loading="$store.state.app.loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图片"  prop="createdBy" width="350" >
          <template slot-scope="scope">
              <div class="banner-img" style="width:48px;height: 48px;background-color: #00948d;">
          ...
          <el-col :span="24">
            <el-form-item label="图片" prop="imgUrl">
              <el-upload
                  ...
                  <img v-if="imgUrl" :src="imgUrl"  style="background-color: #00948d;">
...
import { listService, getContent, delContent, addContent, updateContent } from '@/api/content/content'
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          if (this.form.id !== undefined) {
            updateContent({ ...this.form, type: '3' }).then(res => {
              this.$httpResponse(res.msg)
              this.open = false
              this.getList()
            })
          } else {
            addContent({ ...this.form, type: '3' }).then(res => {
              this.$httpResponse(res.msg)
              this.open = false
              this.getList()
            })
